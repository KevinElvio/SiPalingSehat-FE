        ...
        <div class="content1 mt-20 pl-7 sm:ml-[20%] sm:w-full ">
            <div class="sub-content1 w-full flex flex-col justify-center sm:flex-row sm:justify-evenly sm:items-center items-center">
                <div class="picture flex flex-col items-center">
                    <div class="title-pos w-full flex justify-center mb-9 sm:justify-start">
            ...
            <div class="textfield-profile pr-5 my-8 sm:pl-20 sm:w-full">
                ...
                <div class="button-position w-full flex justify-end">
                <button class="change-pict font-medium w-[80%] h-8 sm:w-64 text-white bg-gray-700 hover:text-white hover:bg-gray-400 flex justify-center items-center my-4 rounded-lg">Save Change</button>
                </div>
            </div>
        </div>
